...
local colormap = {
    ...
    ["et"] = "#ccc",    -- Ethiopia
    ["fi"] = "#ccc",    -- Finland
    ["fo"] = "#ccc",    -- Faroe Islands
    ["fr"] = "#ccc",    -- France
    ["gb"] = "#ccc",    -- United Kingdom
    ["ge"] = "#ccc",    -- Georgia
    ["gh"] = "#ccc",    -- Ghana
    ["gn"] = "#ccc",    -- Guinea
    ["gr"] = "#ccc",    -- Greece
...
local function update_status (self)
    ...
    if (#self._layout > 0) then
        text = ("<span color='#ccc' bgcolor='" .. colormap[self._layout[self._current]] .. "'> " 
            .. self._layout[self._current] .. " </span>")
    end
