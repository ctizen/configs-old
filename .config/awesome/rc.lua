...
run_once(os.getenv("HOME") .. "/.startup_wm.sh")
-- }}}
...
-- {{{ Tags
tags = {
   names = { "communication", "coding", "other" },
   layout1 = { layouts[2], layouts[2], layouts[2] },
   layout2 = { layouts[2], layouts[2], layouts[2] },
   layout3 = { layouts[4], layouts[4], layouts[4] }
}
...
-- calendar
lain.widgets.calendar:attach(mytextclock, { font_size = 10, font = "Terminus" })
